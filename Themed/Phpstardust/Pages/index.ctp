<div class="panel panel-default">
	<div class="panel-heading">
	  <h3 class="panel-title"><i class="fa fa-user"></i> <?php echo __d('phpstardust', 'Pages'); ?> <span class="badge"><?php echo $count; ?></span></h3>
	</div>
	<div class="panel-body">
	  ...
	  <div class="row">
		  ...
		  <div class="col-lg-6">
			  <?php echo $this->Form->create('Page', array('action' => 'index', 'class' => 'navbar-form searchform', 'role' => 'search', 'type' => 'get')); ?>
		  ...
		  <div class="col-lg-12">
			  ...
			  <table class="table table-responsive hidden-xs">
				...
				<tbody>
				  ...
				  <tr>
					...
					<td><?php if ($row['Page']['status']==1) echo '<span class="label label-success">' .__d('phpstardust', 'Published') .'</span>'; else echo '<span class="label label-default">' .__d('phpstardust', 'Draft') .'</span>'; ?></td>
                    <td><?php echo $this->Time->format('Y/m/d H:i:s' , $row['Page']['created']); ?></td>
                    <td>
                      <?php 
					  echo $this->Html->link(
						  '<i class="fa fa-pencil"></i> ' .__d('phpstardust', 'Edit'),
						  array('action' => 'edit', $row['Page']['id']),
						  array('class'=>'btn btn-psd', 'escape' => false)
					  ); 
					  ?>
                      <?php
			  ...
			  <ul class="list-group visible-xs-block mobiletable">
				...
				<li class="list-group-item">
				  <p><strong><?php echo $row['Page']['title']; ?></strong></p>
