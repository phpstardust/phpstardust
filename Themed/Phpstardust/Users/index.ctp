<div class="panel panel-default">
	<div class="panel-heading">
	  <h3 class="panel-title"><i class="fa fa-user"></i> <?php echo __d('phpstardust', 'Users'); ?> <span class="badge"><?php echo $count; ?></span></h3>
	</div>
	<div class="panel-body">
	  ...
	  <div class="row">
		  ...
		  <div class="col-lg-6">
			  <?php echo $this->Form->create('User', array('action' => 'index', 'class' => 'navbar-form searchform', 'role' => 'search')); ?>
			  ...
			  <table class="table table-responsive hidden-xs">
				...
				<tbody>
				  ...
				  <tr>
					...
					<td><?php if ($row['User']['status']==1) echo '<span class="label label-success">' .__d('phpstardust', 'Active') .'</span>'; else echo '<span class="label label-default">' .__d('phpstardust', 'Inactive') .'</span>'; ?></td>
