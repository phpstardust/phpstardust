<div class="panel panel-default">
	  <div class="panel-heading">
		<h3 class="panel-title"><i class="fa fa-wrench"></i> <?php echo __d('phpstardust', 'Settings'); ?></h3>
	  </div>
            ...
            <?php echo $this->Form->create('Setting', array('role' => 'form')); ?>
              ...
              <div class="form-group">
				...
				echo $this->Form->input('language',array(
					'options' => array("eng" => __d('phpstardust', 'English'), "ita" => __d('phpstardust', 'Italian')),
					'label' => __d('phpstardust', 'Language'),
					'class' => 'form-control'
				));
              ...
              <div class="form-group">
				...
				echo $this->Form->input('status',array(
					'options' => array(0 => 'Online', 1 => 'Offline'),
